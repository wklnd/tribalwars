...
import com.twlan.backend.web.dto.VillageSummaryDto;
import com.twlan.backend.service.WorldPoints;
...
public class VillageController {
    ...
    private List<VillageSummaryDto> buildList(World world) {
        ...
        Map<Long, com.twlan.backend.domain.Tribe> tribeOf = tribes.tribeByAccount(world);
