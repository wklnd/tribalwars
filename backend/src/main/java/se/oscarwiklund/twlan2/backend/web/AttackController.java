...
import se.oscarwiklund.twlan2.backend.service.SupportService;
import se.oscarwiklund.twlan2.backend.web.dto.AttackRequest;
...
public class AttackController {
    ...
    public VillageStateDto withdraw(@RequestBody WithdrawRequest request) {
        ...
        supportService.withdraw(se.oscarwiklund.twlan2.backend.web.AccountContext.get(), request.armyId(), units);
    ...
    public VillageStateDto sendBack(@RequestBody SendBackRequest request) {
        supportService.sendBack(se.oscarwiklund.twlan2.backend.web.AccountContext.get(), request.armyId());
        return gameFacade.toDto(gameFacade.playerHomeVillage());
    }
