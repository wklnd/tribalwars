...
import se.oscarwiklund.twlan2.backend.service.AdminService;
...
public class AdminController {
    ...
    public se.oscarwiklund.twlan2.backend.service.AdminService.CompactResult compactWorld(@PathVariable Long id) { return admin.compactWorld(id); }
